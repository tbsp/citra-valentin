...
inline bool Client::set_verify(SSLVerifyMode mode) { return false; }

inline bool Client::add_client_cert_ASN1(std::vector<unsigned char> cert, std::vector<unsigned char> key) { return false; }
...
inline bool SSLClient::set_verify(SSLVerifyMode mode) { return false; }
